...
import sys
sys.path.append('.')
from models.ppg_encoder.papagei.model_utils import resample_batch_signal, load_model_without_module_prefix, get_data_for_ml
...
if __name__ == "__main__":
    ...
    model_path = "checkpoints/papagei/papagei_s.pt"
    model = load_model_without_module_prefix(model, model_path)
    
    x = torch.randn(2, 1, 1250) # 10s * 125 Hz
